...
if __name__ == "__main__":
    ...
    tensor_size = 8192*400*ext_dist.my_size
    emb_len = 128
    ...
    #ext_dist.print_all(send_cnt)
    #ext_dist.print_all(receive_cnt)
    # all to all
    iter = 0
    with torch.profiler.profile(
                ...
                schedule=torch.profiler.schedule(
                    ...
                    warmup=2,
                    active=2),
                on_trace_ready=torch.profiler.tensorboard_trace_handler('./Log_A2A_quan_32_result', worker_name='alltoall_v'),
                record_shapes=True,
        ...
        while iter<10:
            ...
            print(current_time)
            # do quanzation, what does max_pos means?
            send_tensor = torch.ops.fbgemm.FloatToHFP8Quantized(send_tensor, 4, 1, 10.0)
