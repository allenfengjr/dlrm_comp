...
if __name__ == "__main__":
    ...
    tensor_size = 8192*10*ext_dist.my_size
    emb_len = 32
    ...
    ext_dist.print_all("python send tensor list first element, ", send_tensor_list[0][0][0])
    ...
    dimension_info = (c_int*3)(*[tensor_size, emb_len, 1])
