...
DIR = "/home/haofeng/SC_emb_data/SC_Kaggle_emb"
...
EXECUTABLES = {
    # "/home/haofeng/cusz-latest/build/cusz": "-z -i {filename} -t f32 -m r2r -e {error_bound} -l 128x32 --report time",
    "/home/haofeng/sz3_no_pred/bin/sz3": "-f -i {filename} -o tempdata.sz.out -2 128 32 -M REL {error_bound} -a",
    ...
    # "/home/haofeng/nvcomp_software/bin/benchmark_ans_chunked": "-f {filename}",
...
LOG_FILES = {
    ...
    "/home/haofeng/cusz-latest/build/cusz": "CMP_CHECK_cusz.log",
    "/home/haofeng/sz3_no_pred/bin/sz3": "CMP_NO_PRED.log",
    "/home/haofeng/ICS23-GPULZ/gpulz":"CMP_GPULZ.log",
    "/home/haofeng/FZ-GPU/fz-gpu":"CMP_FZGPU.log",
    "/home/haofeng/nvcomp_software/bin/benchmark_lz4_chunked": "CMP_nvCOMP_LZ4.log",
    ...
    "/home/haofeng/nvcomp_software/bin/benchmark_ans_chunked": "CMP_ANS.log"
}
...
for exec_path, exec_args in EXECUTABLES.items():
    for table in range(len(EB)):  # Loop through tables based on the EB list
        for iter in range(1,len(EB[table])):  # Loop through iterations for each table
            ...
            # no pred need ABS eb
            if exec_path == "/home/haofeng/sz3_no_pred/bin/sz3":
                error_bound *= value_range
            # gpulz: first quantization, then compress uint8
            if exec_path == "/home/haofeng/ICS23-GPULZ/gpulz":
                quantization(original_data, error_bound, filename)
                filename = filename+".quan"
