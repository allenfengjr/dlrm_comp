...
os.environ['LD_LIBRARY_PATH'] = '/root/cuSZ/build:' + os.environ.get('LD_LIBRARY_PATH', '')
...
EXECUTABLES = {
    "/root/cusz-latest/build/cusz": "-z -i {filename} -t f32 -m r2r -e {error_bound} -l 2048x64x128 --report time",
    "/root/FZ-GPU/fz-gpu": "{filename} 128 32 1 {error_bound}",
    "/root/cusz-latest/build/example/bin_hf": "{filename} 2048 64 128 256",
    "/root/nvcomp/bin/benchmark_lz4_chunked": "-f {filename}",
    "/root/nvcomp/bin/benchmark_deflate_chunked": "-f {filename}",
    "/root/nvcomp/bin/benchmark_ans_chunked": "-f {filename}",
    "/root/ICS23-GPULZ/gpulz": "-i {filename}",
}


LOG_FILES = {
    # Update or maintain log files corresponding to executables as necessary
    "/root/cusz-latest/build/cusz": "CMP_CHECK_cusz.log",
    "/root/ICS23-GPULZ/gpulz":"CMP_GPULZ.log",
    "/root/FZ-GPU/fz-gpu":"CMP_FZGPU.log",
    "/root/cusz-latest/build/example/bin_hf":"CMP_Huffman.log",
    "/root/nvcomp/bin/benchmark_lz4_chunked": "CMP_nvCOMP_LZ4.log",
    "/root/nvcomp/bin/benchmark_deflate_chunked": "CMP_nvCOMP_deflate.log",
    "/root/nvcomp/bin/benchmark_ans_chunked": "CMP_ANS.log"
}
